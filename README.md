...
* Please note you will have to download the helper library from the following links (based on your version of Epicor) and unzip it into your client folder
    ...
    [10.2.300.X](https://josecgomez.com/files/CustomizationHelper.10.2.300.X.zip?0.25.0)

    [10.2.200.X](https://josecgomez.com/files/CustomizationHelper.10.2.200.X.zip?0.25.0)
